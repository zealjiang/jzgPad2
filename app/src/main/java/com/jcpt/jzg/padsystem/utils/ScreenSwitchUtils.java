 ...
 * @Description: 由重力感应来判断设备的方向（0,90,180,270） 自然不受界面设置横竖屏配置的影响。
 *                 以此达到自定义相机无论旋转成何种角度拍摄照片都能按拍照时显示正常方位，而不是倒着 斜着之类
 */
public class ScreenSwitchUtils {
    ...
    public static final int ORIENTATION_DIGREE_180 = 180;
    public static final int ORIENTATION_DIGREE_270 = 270;
            ...
            switch (msg.what) {
                case 888:
                    ...
                    if (orientation > 45 && orientation < 135) {
                        ...
                        screenOrientation = ORIENTATION_DIGREE_180;
                    } else if (orientation > 135 && orientation < 225) {
                        Log.e("test", "135 - - 225 切换");//270
                        screenOrientation = ORIENTATION_DIGREE_270;
