 ...
 * @Description: 检测项搜索界面
 */
public class BMWSearchCheckActivity extends BaseActivity implements View.OnLayoutChangeListener {
        ...
        etCheck.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    //隐藏软键盘
                    UIUtils.hideInputMethodManager(BMWSearchCheckActivity.this);
...
//                                MyToast.showShort("右边");
    ...
    private void searchCheckItemList(String searchItem) {
        ...
        List<CheckItem> imcheckItemList = BMWDetectMainActivity.detectMainActivity.getCheckItemList();
        ...
        List<CheckItem> unimcheckItemList = BMWDetectMainActivity.detectMainActivity
                .getUncheckItemList();
