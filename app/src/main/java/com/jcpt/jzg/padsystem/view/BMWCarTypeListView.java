...
import com.jcpt.jzg.padsystem.adapter.BMWCarTypeListAdapter;
...
public class BMWCarTypeListView extends LinearLayout implements ICarDiffInterface {
    ...
    private BMWCarTypeListAdapter carTypeListAdapter;
    ...
    private BMWCarTypeListView.OnListDataLoadOverListener onListDataLoadOverListener;
    ...
    public BMWCarTypeListView(Context context) {
        super(context);
        this.context = context;
        initView();
    }

    public BMWCarTypeListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        initView();
    }

    public BMWCarTypeListView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.context = context;
        initView();
    }

    public void setBMWDetectMainActivity(BMWDetectMainActivity detectMainActivity){
    ...
    private void initView() {
        ...
        carTypeListAdapter = new BMWCarTypeListAdapter(showDatas);
        rvType.setAdapter(carTypeListAdapter);
        carTypeListAdapter.setOnItemClickListener(new BMWCarTypeListAdapter.OnItemClickListener() {
            @Override
    ...
    public interface OnListDataLoadOverListener{
        public void onListDataLoadOver(List<CarTypeSelectModel.MemberValueBean.ConfigListBean>
                                               listData, String brandSeriesName);
        public void onFileterOutCar(List<CarTypeSelectModel.MemberValueBean.ListBeanX.ListBean> filterCars);
    }

    public void setOnListDataLoadOverListener(BMWCarTypeListView.OnListDataLoadOverListener onListDataLoadOverListener){
