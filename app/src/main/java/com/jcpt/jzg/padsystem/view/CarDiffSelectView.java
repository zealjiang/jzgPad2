...
public class CarDiffSelectView extends LinearLayout {


    @BindView(R.id.tagflow_diff_config)
    TagFlowLayout tagFlowDiff;
    private CarDiffSelectView self;
    ...
    private CarDiffSelectView.OnDiffSelectedItemListener onDiffSelectedItemListener;
    private DetectMainActivity detectMainActivity;

    public CarDiffSelectView(Context context) {
        super(context);
        initView();
    }

    public CarDiffSelectView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public CarDiffSelectView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setOnDiffSelectedItemListener(CarDiffSelectView.OnDiffSelectedItemListener onDiffSelectedItemListener){
