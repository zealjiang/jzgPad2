 ...
 */
public class CarPhotoDefectFragment extends BaseFragment implements PhotoDefectExpandableAdapter.IchooseFlawPhotoLister {
...
//
                                                                                    if(getPicDefectHttpUrlList.get(p).getUriID().equals(picId)){
                                                                                        getPicDefectHttpUrlList.get(p).setPicPath("");
                                                                                    }

                                                                                    if(!TextUtils.isEmpty(getPicDefectHttpUrlList.get(p).getPicPath())){
