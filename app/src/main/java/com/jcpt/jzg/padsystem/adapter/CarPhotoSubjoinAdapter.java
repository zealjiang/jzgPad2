...
public class CarPhotoSubjoinAdapter extends RecyclerView.Adapter<CarPhotoSubjoinAdapter.ViewHolder> {

    List<PictureItem> dataLists;
    OnClickDelLister mOnClickDelLister;
    private Context context;
    private CarPhotoSubjoinAdapter.OnItemClickListener itemClickListener;
    private boolean isOpenCamera;

    public CarPhotoSubjoinAdapter(Context context,List<PictureItem> data,boolean isOpenCamera) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        CarPhotoSubjoinAdapter.ViewHolder viewHolder = new CarPhotoSubjoinAdapter.ViewHolder(view);
        return viewHolder;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        if (isOpenCamera) {
            if (position == 0) {
                ...
                DetectionModel.loadResPic(holder.ivCar, R.drawable.tianjiapic);
            } else {
                holder.img.setVisibility(View.GONE);
    ...
    public void setOnItemClickListener(CarPhotoSubjoinAdapter.OnItemClickListener listener) {
