 ...
 */
public class CarPhotoSubjoinFragment extends BaseFragment{
    ...
    private CarPhotoSubjoinAdapter adapter;
    ...
    public CarPhotoSubjoinFragment() {
    ...
    public void init(){
        ...
        adapter = new CarPhotoSubjoinAdapter(context,pictureItems,true);
        recyclerview.setAdapter(adapter);

        adapter.setOnItemClickListener(new CarPhotoSubjoinAdapter.OnItemClickListener() {
            @Override
    ...
    public void initDatapictureItems(){
        ...
        //读取详情返回网络图片
        mTaskDetailModel = ((DetectMainActivity) getActivity()).getTaskDetailModel();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==PHOTO_BIG_PHOTO&&resultCode== Activity.RESULT_OK){
            ...
            compress(context, file.getAbsolutePath(),curphotoPrefix, ((DetectMainActivity)getActivity()).getTaskid());
        }
