 ...
 * 宝马提交
 */
public class BMWSubmitPresenter extends BasePresenter<ISubmit> {
    public BMWSubmitPresenter(ISubmit from) {
        super(from);
    }

    public void submitBMW(String json, final int ifConfirmPrice, String confirmPrice) {
        ...
        PadSysApp.getApiServer().submitBMW(params)
