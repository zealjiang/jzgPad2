...
public class WheelOptions<T> {
    ...
    private List<List<List<List<List<T>>>>> mOptions5Items;
    private List<T> N_mOptions3Items;
    private List<T> N_mOptions4Items;
    private List<T> N_mOptions5Items;
    ...
    public void setNPicker(List<T> options1Items,
        ...
        // 选项5
        if (N_mOptions5Items != null) {
            wv_option5.setAdapter(new ArrayWheelAdapter(N_mOptions5Items));// 设置显示数据
            wv_option5.setCurrentItem(wv_option5.getCurrentItem());
        }
        wv_option1.setIsOptions(true);
        wv_option2.setIsOptions(true);
        wv_option3.setIsOptions(true);
        wv_option4.setIsOptions(true);
        wv_option5.setIsOptions(true);
    ...
    public void setTextContentSize(int textSize) {
        ...
        wv_option5.setTextSize(textSize);
    }
    ...
    private void setTextColorOut() {
        ...
        wv_option5.setTextColorOut(textColorOut);
    ...
    private void setTextColorCenter() {
        ...
        wv_option5.setTextColorCenter(textColorCenter);
    ...
    private void setDividerColor() {
        ...
        wv_option5.setDividerColor(dividerColor);
    }
    ...
    private void setDividerType() {
        ...
        wv_option5.setDividerType(dividerType);
    }
    ...
    private void setLineSpacingMultiplier() {
        ...
        wv_option5.setLineSpacingMultiplier(lineSpacingMultiplier);
     ...
     */
    public void setCyclic(boolean cyclic1, boolean cyclic2, boolean cyclic3, boolean cyclic4, boolean cyclic5) {
        wv_option1.setCyclic(cyclic1);
        wv_option2.setCyclic(cyclic2);
        wv_option3.setCyclic(cyclic3);
        wv_option4.setCyclic(cyclic4);
        wv_option5.setCyclic(cyclic5);
    }
    ...
    public int[] getCurrentItems() {
        ...
        if (mOptions5Items != null && mOptions5Items.size() > 0) {//非空判断
            currentItems[4] = wv_option5.getCurrentItem() > (mOptions5Items.get(currentItems[0]).get(currentItems[1]).get(currentItems[2]).get(currentItems[3]).size() - 1) ? 0 : wv_option5.getCurrentItem();
        } else {
    ...
    public void setCurrentItems(int option1, int option2, int option3, int option4, int option5) {
        if (linkage) {
            itemSelected(option1, option2, option3, option4, option5);
        }
    ...
    private void itemSelected(int opt1Select, int opt2Select, int opt3Select, int opt4Select, int opt5Select) {
        if (mOptions2Items != null) {
        ...
        if (mOptions5Items != null) {
            wv_option5.setAdapter(new ArrayWheelAdapter(mOptions5Items.get(opt1Select).get(opt2Select).get(opt3Select).get(opt4Select)));
            wv_option5.setCurrentItem(opt5Select);
        }
    }
    ...
    public void isCenterLabel(Boolean isCenterLabel) {
        ...
        wv_option5.isCenterLabel(isCenterLabel);
    }
