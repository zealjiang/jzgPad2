...
public class BMWCarTypeListAdapter extends RecyclerView.Adapter<BMWCarTypeListAdapter.SimpleItemViewHolder>{
    ...
    public BMWCarTypeListAdapter(List<CarTypeSelectModel.MemberValueBean.ListBeanX.ListBean> datas){
        this.datas = datas;
