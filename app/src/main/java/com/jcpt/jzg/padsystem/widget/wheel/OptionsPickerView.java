...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    public OptionsPickerView(Builder builder) {
        ...
        this.cyclic4 = builder.cyclic4;
        this.cyclic5 = builder.cyclic5;
    ...
    public static class Builder {
        ...
        private boolean cyclic4 = false;
        private boolean cyclic5 = false;
        ...
        public Builder setLabels(String label1, String label2, String label3, String label4, String label5) {
            this.label1 = label1;
            this.label2 = label2;
            this.label3 = label3;
            this.label3 = label4;
        ...
        public Builder setCyclic(boolean cyclic1, boolean cyclic2, boolean cyclic3,boolean cyclic4, boolean cyclic5) {
            this.cyclic1 = cyclic1;
            this.cyclic2 = cyclic2;
            this.cyclic3 = cyclic3;
            this.cyclic4 = cyclic4;
            this.cyclic5 = cyclic5;
            return this;
        }
        ...
        public Builder setSelectOptions(int option1, int option2, int option3, int option4) {
            this.option1 = option1;
            this.option2 = option2;
            this.option3 = option3;
        ...
        public Builder setSelectOptions(int option1, int option2, int option3, int option4, int option5) {
            this.option1 = option1;
            this.option2 = option2;
            this.option3 = option3;
            this.option4 = option4;
    ...
    private void initView(Context context) {
        ...
        wheelOptions.setCyclic(cyclic1, cyclic2, cyclic3, cyclic4, cyclic5);
    ...
    public void setNPicker(List<T> options1Items,
        ...
        wheelOptions.setNPicker(options1Items, options2Items, options3Items,options4Items,options5Items);
        SetCurrentItems();
    }
    ...
    public void returnData() {
        if (optionsSelectListener != null) {
            ...
            optionsSelectListener.onOptionsSelect(optionsCurrentItems[0], optionsCurrentItems[1], optionsCurrentItems[2], optionsCurrentItems[3], optionsCurrentItems[4], clickView);
        }
    }

    public interface OnOptionsSelectListener {
        void onOptionsSelect(int options1, int options2, int options3, int options4, int options5, View v);
    }
